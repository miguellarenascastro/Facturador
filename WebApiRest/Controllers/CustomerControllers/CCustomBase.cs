...
namespace WebApiRest.Controllers.CustomerControllers
{
    public class CCustomBase : ControllerBase
    {
        private readonly dbSRICompElectContext context;
        private readonly IMapper mapper;

        public CCustomBase(dbSRICompElectContext context, IMapper mapper)
        {
        ...
        protected async Task<ActionResult<TDTO>> Get<TEntidad, TDTO>(int id) where TEntidad : class, ID
        {
        ...
        protected async Task<ActionResult> Post<TCreacion, TEntidad, TLectura>
            (TCreacion creacionDTO, string nombreRuta) where TEntidad : class, ID
        {
        ...
        protected async Task<ActionResult> Put<TCreacion, TEntidad>
            (int id, TCreacion creacionDTO) where TEntidad : class, ID
        {
            var entidad = mapper.Map<TEntidad>(creacionDTO);
            entidad.Id = id;
        ...
        protected async Task<ActionResult> Delete<TEntidad>(int id) where TEntidad : class, ID, new()
        {
